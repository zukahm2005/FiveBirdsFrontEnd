        ...
        <div className="content-fluid flex-row">
          ...
          <div className="heading-content flex-col">
            ...
            <div className="content-middle">
              <p>
                The military industry offers not only challenging career
                opportunities but also the chance to contribute to global safety
                and sustainable development. Here, you will take part in
                projects involving the production and research of cutting-edge
                technology, meeting the highest standards. Collaborate with top
                experts to develop groundbreaking solutions for the defense
                sector. This is your opportunity to be part of critical projects
                that help safeguard the future.
              </p>
            </div>
